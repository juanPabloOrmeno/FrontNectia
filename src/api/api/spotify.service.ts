...
import { ResponseBuscar } from '../model/responseBuscar';
import { ResponseNuevo } from '../model/responseNuevo';
...
export class SpotifyService {
    ...
    protected basePath = '{protocol}://localhost:3000';
     ...
     * busqueda
     * 
     * @param buscar lo que quieres buscar.
    ...
    public buscarGet(buscar?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (buscar !== undefined && buscar !== null) {
            queryParameters = queryParameters.set('buscar', <any>buscar);
        }
